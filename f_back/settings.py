"""
Django settings for f_back project.
...
SECRET_KEY = 'django-insecure-tz6q5x+mmmhp=$v-fgmt3&65(z!6n^kvpw#j(f$agp%c74sl_j'
...
WSGI_APPLICATION = 'f_back.wsgi.application'
